...
<body>
    <main>
        ...
        <section class="content">
            <div class="textual">
                <h1>Hi <span class="green">Martin</span>...</h1>
                <p>
                    Thank you for <span class="orange">creating</span> an acccount with RZA
                </p>
                <h2><span class="green">Welcome to the club</span></h2>
            </div>

            <div class="actionable">
                <a href="" class="btn btn-success">Continue / <b>Start</b> Making a Hotel Booking</a>
                <a href="" class="btn btn-warning">I want to Visit the Safari</a>
                <a href="" class="btn btn-warning">Manage My Profile</a>
