    ...
    <main>
        <section class="promotion">
            ...
            <div class="sub-banner">
                <h3><span class="bold">...and get a chance to <span class="orange">get 20% off</span> your <u>Safari
                            Tickets</u> on first booking</span></h3>
            </div>
        </section>

        <section class="main more-options">
            <section class="upcoming-events">
                <h3>Upcoming Events</h3>
                <div class="info">
                    <img src="../images/RZA-images/pointer.svg" alt="Pointing Finger">
                    <a href="">
                        <h5>Want to View Our latest Upcoming Events</h5>
                    </a>
                </div>
            </section>
            <section class="sites">
                <h3>Sites to see</h3>
                <div class="info">
                    <img src="../images/RZA-images/address.svg" alt="Pin Location Icon">
                    <a href="">
        ...
        <section class="text-content">
            <div class="textual">
                <h3>Your first Time... <mark><span class="bold white">READ-ME</span></mark></h3>
                <br><br>
                <p>
            ...
            <div class="bordered">
                <div class="faq">
                    <div class="faq-img-content">
                        ...
                        <h4>
                            I want Educational Materials for my students
                        </h4>
                    </div>
                    <ul>
                        <li>
                            <p>
                                Look for an elephant icon anywhere. These icons are links to the educational materials
                                we
                                provide
                            </p>
                        </li>
