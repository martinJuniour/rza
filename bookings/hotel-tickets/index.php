    ...
    <header>
        ...
        <nav>
            ...
            <div class="nav-items">
                ...
                <a href="index.php">Book a Night in Hotel</a>
        ...
        <div class="intro">
            <h1 class="first"><span class="green">Fancy</span> a night under the sky <span class="green">...</span></h1><br>
            <h1 class="second"><span class="green">...</span>or a <span class="orange">safari themed</span> stroll during the day ?</h1>
            <br>

            <div class="next">
                <a href="<?php echo $_SESSION['login'] ? 'book.php' : 'error.html' ;?>" class="btn btn-warning"><span class="white">Next </span>→</a>
            </div>
        </div>
