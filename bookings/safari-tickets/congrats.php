...
<body>
    ...
    <header>
        ...
        <section class="done">
            <h1>Con<span class="green">grad</span>ulations<span class="orange">.</span></h1>
            <p>
                    Your <span class="green">Ticket Purchase was</span> successful.
                    Below is your <span class="orange">reference number</span> for the ticket booking. You can always
                    find this in your profile
                    management Tab if you have an RZA account. See verification email for further details about
