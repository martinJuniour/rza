...
<head>
    ...
    <link rel="stylesheet" href="../hotel-tickets/payment-media.css">
...
<body>
    ...
    <main>
        ...
        <section class="payment">
            ...
            <div class="head">
                <h1>Safari <span class="orange">tickets confirmation</span>.</h1>
                <h3>Please input payment detail below</h3>
            </div>
